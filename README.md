...
*   **2026-07-20** — README rewritten around the V2 architecture (this document), with `README_v2.md` added as the technical/release companion. Guide pages also regained their explorer context after a route-refactor regression, and the unreachable-route test fixture was refreshed.
